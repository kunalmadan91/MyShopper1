 ...
 * {@link FurnitureFragment.OnFragmentInteractionListener} interface
...
public class FurnitureFragment extends Fragment {
    ...
    private List<Products> furnitureList;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        for(Products list:productsList) {
            if(list.getCategory().equals("FUR")){
                furnitureList.add(list);
            }
        }



        adapter = new ProductAdapter(getActivity(), furnitureList);
